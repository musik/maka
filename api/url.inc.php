...
$urls['htm']['list'][0] = array('example'=>'('.$L['url_htm'].') disk/25.html','index'=>'{$catdir}/{$index}.{$file_ext}', 'page'=>'{$catdir}/{$prefix}{$page}.{$file_ext}');
...
$urls['htm']['item'][2] = array('example'=>'('.$L['url_htm'].') disk/1/125.html','index'=>'{$catdir}/{$alloc}/{$prefix}{$itemid}.{$file_ext}', 'page'=>'{$catdir}/{$alloc}/{$prefix}{$itemid}_{$page}.{$file_ext}');
...
$urls['htm']['item'][4] = array('example'=>'('.$L['url_htm'].') disk/125.html','index'=>'{$catdir}/{$prefix}{$itemid}.{$file_ext}', 'page'=>'{$catdir}/{$prefix}{$itemid}_{$page}.{$file_ext}');
