DROP TABLE IF EXISTS `destoon_subject_61`;
CREATE TABLE `destoon_subject_61` (
...
) TYPE=MyISAM COMMENT='话题';

DROP TABLE IF EXISTS `destoon_subject_data_61`;
CREATE TABLE `destoon_subject_data_61` (
  `itemid` bigint(20) unsigned NOT NULL default '0',
  `content` mediumtext NOT NULL,
  PRIMARY KEY  (`itemid`)
) TYPE=MyISAM COMMENT='话题内容';
